...
const SetNewPassword = () =>{
    ...
    const handleSetNewPassword=()=>{
        ...
        console.log(setpass);
        axios.post("https://delta-internship.eu-west-1.elasticbeanstalk.com/api/auth/confirm-reset-password",null,{params:{code,password}}).then(Response=>{
            ...
            <div className='box-newPass'>
                ...
                <div className='inputBox'>
                    <TextField 
                        ...
                        {password==="password"?(
                            <span className="iconSetNew" onClick={()=>setPassword("text")}>
                                <Icon icon={basic_eye_closed} size={25}/>
                            </span>
                        ):(
                            <span className="iconSetNew" onClick={()=>setPassword("password")}>
